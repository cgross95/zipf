...
def get_power_law_params(word_counts):
    ...
    References
    ----------
    Moreno-Sanchez et all (2016) define alpha (Eq. 1), beta (Eq. 2) and the
    maximum likelihood estimation (mle) of beta (Eq. 6).
...
def main(args):
    ...
    # Use the range of the data as the boundaries when drawing the power law
    # curve
